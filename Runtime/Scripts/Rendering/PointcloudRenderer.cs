    ...
    public class PointcloudRenderer : MonoBehaviour, IPointCloudRenderer
    {
        ...
        public void Setup(SequenceConfiguration configuration, Transform parent, float pointSize, float emission, GeometrySequenceStream.PointType pointType)
        {
            ...
            if (computeShader == null)
                computeShader = (ComputeShader)Instantiate(Resources.Load("PointcloudCompute"));
        ...
        {
            pcMeshRenderer.material = new Material(GetPointcloudMaterialFromType(type));
